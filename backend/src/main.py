...
async def create_tables():
    ...
    try:
        ...
        from src.models import sse_connection, portfolio_valuation, poll_interval_config  # noqa: F401  
        from src.models import api_usage_metrics, administrative_override  # noqa: F401
